...
async def main():
    ...
    def change_color_line(current_index: int, increment: int):
    ...
    def change_color_column(current_index: int, increment: int):
    ...
    while True:  # EVENT LOOP
        for event in pygame.event.get():
            ...
            if event.key == pygame.K_a:
                color_index_line = change_color_line(color_index_line, -1)

            if event.key == pygame.K_d:
                color_index_line = change_color_line(color_index_line, 1)

            if event.key == pygame.K_w:
                color_index_column = change_color_column(color_index_column, -1)
